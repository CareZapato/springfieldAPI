...
export declare type RequestQuery = Record<string, any>;
export declare type RequestBody = Record<string, any> | null;
export declare type ResponseHeaders = Record<string, any>;
...
export declare type MockParams = Pick<Mock, 'url' | 'method' | 'responseCode' | 'responseHeaders'>;
export interface Mock {
     ...
     */
    responseFn: (requestQuery: RequestQuery, requestBody: RequestBody) => MockResponse['responseBody'];
    /**
...
export interface MockOptions {
     ...
     */
    responseProxyFn?: (responseBody: any, // The result of the `responseFn: (requestQuery: RequestQuery, requestBody: RequestBody) => any`
    mockParams: MockParams, mockRequest: MockRequest) => MockResponse;
    /**
